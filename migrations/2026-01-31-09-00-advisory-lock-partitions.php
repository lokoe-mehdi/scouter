<?php
/**
 * Migration: Ajouter un advisory lock à create_crawl_partitions
 * 
 * Problème: Quand plusieurs crawls démarrent simultanément, ils essaient tous
 * de créer leurs partitions en même temps. CREATE TABLE prend un lock exclusif
 * sur le catalogue PostgreSQL, causant des erreurs 55P03 (lock_not_available).
 * 
 * Solution: Utiliser pg_advisory_lock() pour sérialiser la création des partitions.
 * Un seul crawl à la fois peut créer ses partitions, les autres attendent.
 */
...
try {
    echo "   → Mise à jour de la fonction create_crawl_partitions avec advisory lock... ";
