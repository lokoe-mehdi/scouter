...
func newTestUTLS() *utlsTransport {
	return newUTLSTransport(4) // tlsConfig already InsecureSkipVerify for test servers
}
...
func TestUTLSTransportHTTP2(t *testing.T) {
...
func TestUTLSTransportHTTP1Fallback(t *testing.T) {
...
func TestUTLSTransportConnReuse(t *testing.T) {
	var conns int32
	srv := httptest.NewUnstartedServer(http.HandlerFunc(func(w http.ResponseWriter, _ *http.Request) {
		w.WriteHeader(http.StatusOK)
	}))
